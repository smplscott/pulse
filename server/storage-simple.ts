...
export class MemStorage implements IStorage {
  ...
  async createThread(insertThread: InsertThread): Promise<Thread> {
    ...
    const thread: Thread = {
      ...
      showId: (insertThread as any).showId || null,
      albumId: (insertThread as any).albumId || null,
      albumName: (insertThread as any).albumName || null,
      artistName: (insertThread as any).artistName || null,
